...
Version  : 1.4.4.1
Release  : 31
URL      : https://cran.r-project.org/src/contrib/httpuv_1.4.4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/httpuv_1.4.4.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1529722898
