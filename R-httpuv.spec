...
Version  : 1.5.3.1
Release  : 56
URL      : https://cran.r-project.org/src/contrib/httpuv_1.5.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/httpuv_1.5.3.1.tar.gz
Summary  : HTTP and WebSocket Server Library
Group    : Development/Tools
License  : CC-BY-4.0 GPL-2.0 GPL-2.0+ MIT
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590680479
