...
Version  : 1.4.3
Release  : 30
URL      : https://cran.r-project.org/src/contrib/httpuv_1.4.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/httpuv_1.4.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526838808
